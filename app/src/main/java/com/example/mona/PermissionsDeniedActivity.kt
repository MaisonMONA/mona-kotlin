...
class PermissionsDeniedActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_try_again_request_permissions_id.setOnClickListener(View.OnClickListener {
            /*
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED ||
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION) ||
                    ...
                    ActivityCompat.requestPermissions(this, arrayOf(
                        ...
                        PermissionsDeniedActivity.MY_PERMISSIONS_REQUEST_FINE_LOCATION_AND_WRITE_EXTERNAL)
                }
            }else{
